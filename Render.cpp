...
void Render::SetupFonts()
{
	...
	g_Surface->SetFontGlyphSet(font.ESP, "Tahoma", 10, 700, 0, 0, FONTFLAG_ANTIALIAS);
	g_Surface->SetFontGlyphSet(font.Defuse, "Tahoma", 14, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.Guns, "Tahoma", 11, 700, 0, 0, FONTFLAG_ANTIALIAS);
	g_Surface->SetFontGlyphSet(font.Time, "Arial", 13, 550, 0, 0, FONTFLAG_ANTIALIAS);
	...
	g_Surface->SetFontGlyphSet(font.Watermark, "Tahoma", 11, 700, 0, 0, FONTFLAG_ANTIALIAS);
